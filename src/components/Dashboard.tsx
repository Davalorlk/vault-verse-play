            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white font-medium">{userStats.displayName}</span>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-white">{userStats.puzzlesSolved}</div>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-white">{userStats.experience}</div>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-white">Level {userStats.level}</div>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-white">{userStats.coins}</div>
